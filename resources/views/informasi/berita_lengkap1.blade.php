        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-7/12">
                ...
                <div class="rounded-2xl overflow-hidden mb-4">
                    <img src="{{ asset('assets/Berita1.png') }}" alt="Berita Utama"
                ...
                <p class="text-gray-700 text-base leading-relaxed space-y-4">
                    ...
                    Menurutnya, pointer kedu Kesedihan adalah bagian alami dari hidup. Namun, kesedihan ini harus
            ...
            <div class="lg:w-1/3 flex flex-col gap-6">
                <!-- Card 1 -->
                <div
                    class="bg-white rounded-xl shadow-md overflow-hidden hover:scale-105 hover:shadow-lg transition-transform transition-shadow duration-300">
                    <img class="w-full h-40 object-cover" src="{{ asset('assets/Berita2.png') }}" alt="Berita 2" />
                ...
                <div
                    class="bg-white rounded-xl shadow-md overflow-hidden hover:scale-105 hover:shadow-lg transition-transform transition-shadow duration-300">
                    <img class="w-full h-40 object-cover" src="{{ asset('assets/Berita3.png') }}" alt="Berita 3" />
                    <div class="p-4 flex flex-col justify-between">
                        <div>
                            <h3 class="text-base md:text-lg font-semibold text-gray-900 mb-1 line-clamp-2">
