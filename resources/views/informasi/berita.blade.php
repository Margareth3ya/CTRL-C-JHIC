    ...
    <section class="py-12 md:py-16">
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-col lg:flex-row gap-6 md:gap-8">
                <!-- Gambar Besar Kiri -->
                <a href="/informasi/berita/berita-lengkap1" class="lg:w-2/3 group relative rounded-xl overflow-hidden cursor-pointer">
                    <div class="relative w-full h-64 md:h-[500px]">
                        ...
                        <div class="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition duration-300 p-6 flex flex-col justify-end">
                ...
                <div class="lg:w-1/3 flex flex-col gap-6">
                    <!-- Card 1 -->
                    <div class="flex flex-1 bg-white rounded-xl shadow-md overflow-hidden hover:scale-105 hover:shadow-lg transition-transform transition-shadow duration-300">
                        <img
