...
<div class="min-h-screen">
    ...
    <section class="ekskul-section">
        ...
        <!-- Page 2 -->
        <div class="ekskul-page" id="ekskul-page-2">
            <div class="ekskul-grid">
                <!-- Cards for page 2 -->
            </div>
        </div>
        ...
        <!-- Page 3 -->
        <div class="ekskul-page" id="ekskul-page-3">
            <div class="ekskul-grid">
                <!-- Cards for page 3 -->
            </div>
        </div>
        ...
        <!-- Page 4 -->
        <div class="ekskul-page" id="ekskul-page-4">
            <div class="ekskul-grid">
                <!-- Cards for page 4 -->
            </div>
        </div>
...
<script>
    ...
    const CARDS_PER_PAGE = 9; // 3 rows × 2 cards per row
    let currentPage = 1;
    ...
    function renderEkskulCards() {
        ...
        for (let i = 1; i <= totalPages; i++) {
            ...
            if (pageContainer) {
                const grid = pageContainer.querySelector('.ekskul-grid');
                grid.innerHTML = '';
            }
        }
        ...
        ekskulData.forEach((ekskul, index) => {
            ...
            if (pageContainer) {
                ...
                card.style.animationDelay = `${(index % CARDS_PER_PAGE) * 0.1}s`;
