...
<div class="min-h-screen">
    ...
    <section class="py-24 md:py-16 px-4 relative overflow-hidden">
        <div class="max-w-4xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-2xl border border-gray-100 relative overflow-hidden">
            <!-- Animated background gradient -->
            <div class="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-to-r from-orange-100/20 via-blue-100/20 to-orange-100/20 animate-spin-slow"></div>
            ...
            <h2 class="text-4xl md:text-5xl font-bebas text-center mb-4 bg-gradient-to-br from-gray-800 to-gray-700 bg-clip-text text-transparent relative z-10">
                ORGANISASI OSIS
            </h2>
    ...
    <section class="py-16 md:py-20 px-4">
        <h2 class="text-4xl md:text-5xl font-bebas text-center mb-12 bg-gradient-to-br from-gray-800 to-gray-700 bg-clip-text text-transparent relative">
            EKSTRAKURIKULER
            <span class="absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-orange-500 to-orange-300 rounded"></span>
        </h2>
        
        <!-- Page 1 -->
        <div class="ekskul-page active" id="ekskul-page-1">
        ...
        <!-- Page 2 -->
        <div class="ekskul-page hidden" id="ekskul-page-2">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                <!-- Cards will be populated by JavaScript -->
            </div>
        </div>
        ...
        <!-- Page 3 -->
        <div class="ekskul-page hidden" id="ekskul-page-3">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                <!-- Cards will be populated by JavaScript -->
            </div>
        </div>
        ...
        <!-- Page 4 -->
        <div class="ekskul-page hidden" id="ekskul-page-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                <!-- Cards will be populated by JavaScript -->
            </div>
        </div>
        ...
        <!-- Pagination Controls -->
        <div class="flex justify-center items-center mt-16 mb-8 gap-4 flex-wrap">
            <button class="px-7 py-3.5 bg-gradient-to-br from-orange-500 to-orange-600 text-white border-none rounded-xl font-poppins font-semibold cursor-pointer transition-all duration-300 shadow-lg shadow-orange-500/30 relative overflow-hidden hover:-translate-y-1 hover:shadow-xl hover:shadow-orange-500/40 disabled:bg-gradient-to-br disabled:from-gray-300 disabled:to-gray-400 disabled:cursor-not-allowed disabled:transform-none disabled:shadow disabled:shadow-gray-300/30 pagination-btn" id="prev-btn" disabled>
                ← Sebelumnya
            </button>
            
            <div class="font-poppins font-semibold text-gray-700 bg-gray-50 px-6 py-3 rounded-xl border border-gray-200 min-w-[120px] text-center page-info">
                Halaman <span id="current-page">1</span> dari <span id="total-pages">4</span>
            </div>
            
            <button class="px-7 py-3.5 bg-gradient-to-br from-orange-500 to-orange-600 text-white border-none rounded-xl font-poppins font-semibold cursor-pointer transition-all duration-300 shadow-lg shadow-orange-500/30 relative overflow-hidden hover:-translate-y-1 hover:shadow-xl hover:shadow-orange-500/40 disabled:bg-gradient-to-br disabled:from-gray-300 disabled:to-gray-400 disabled:cursor-not-allowed disabled:transform-none disabled:shadow disabled:shadow-gray-300/30 pagination-btn" id="next-btn">
                Selanjutnya →
            </button>
        </div>
    </section>
    ...
    function renderEkskulCards() {
        ...
        ekskulData.forEach((ekskul, index) => {
            ...
            if (pageContainer) {
                ...
                card.className = 'bg-white rounded-2xl overflow-hidden shadow-xl transition-all duration-400 border border-gray-100 hover:-translate-y-3 hover:shadow-2xl hover:border-orange-500 relative opacity-0 transform translate-y-8 transition-all duration-500 ease-out scroll-reveal';
        ...
        buttons.forEach(button => {
            button.addEventListener('mouseenter', function() {
                if (!this.disabled) {
                    ...
                    before.className = 'absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent transform -skew-x-12 -translate-x-full';
