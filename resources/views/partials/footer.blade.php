...
<footer class="container flex mx-auto p-2 rounded-3xl bg-gradient-to-b from-gray-900 to-gray-800 text-gray-300 px-6 md:px-16 py-5 relative overflow-hidden">
